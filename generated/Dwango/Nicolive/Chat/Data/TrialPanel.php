...
class TrialPanel extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Dwango\Nicolive\Chat\Data\TrialPanel\Panel::class);
        $this->panel = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Dwango\Nicolive\Chat\Data\TrialPanel\Mode::class);
